class Character
    ...
    def initialize(name="Monster")
        @health = 50
        @name = name
        @win_message = name == "Monster" ? "You fall to the floor fatally wounded. The monster comes in for the kill. You black out from the pain. Game Over, #{@name}" : "The monster shreeks and falls to the floor dead. You did it, #{@name}! YOU SURVIVED!"
    end
